...
create table tasks (id bigint generated by default as identity, name varchar(255) not null, description varchar(255), priority varchar(255), state_id bigint, todo_id bigint, primary key (id));
create table todo_collaborator (collaborator_id bigint not null, todo_id bigint not null);
create table todos (id bigint generated by default as identity, created_at timestamp not null, title varchar(255) not null, description varchar(255), owner_id bigint, primary key (id));
create table users (id bigint generated by default as identity, email varchar(255) not null, first_name varchar(255) not null, last_name varchar(255) not null, sex varchar(255) not null, password varchar(255) not null, role_id bigint, primary key (id));
